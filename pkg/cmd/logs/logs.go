...
func NewLogsOptions(streams genericiooptions.IOStreams, allContainers, allPods bool) *LogsOptions {
	return &LogsOptions{
		IOStreams:            streams,
...
func (o *LogsOptions) AddFlags(cmd *cobra.Command) {
	cmd.Flags().BoolVar(&o.AllPods, "all-pods", o.AllContainers, "Get all containers' logs in the pod(s).")
